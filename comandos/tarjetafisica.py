...
# =============== Comando principal ===============
async def tarjetafisica_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /tarjetafisica.",
    ...
    command_cfg = get_command_runtime_config("tarjetafisica", 10)
    ...
    await create_request(update, context, "tarjetafisica", cost=required_credits)
