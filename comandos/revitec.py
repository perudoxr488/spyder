...
# =============== Comando principal ===============
async def revitec_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /revitec.",
    ...
    command_cfg = get_command_runtime_config("revitec", 10)
    ...
    await create_request(update, context, "revitec", cost=required_credits)