...
async def pla_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /pla.",
    ...
    command_cfg = get_command_runtime_config("pla", 3)
    ...
    await create_request(update, context, "pla", cost=required_credits)