...
# =============== Comando principal ===============
async def tiveor_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /tiveor.",
    ...
    command_cfg = get_command_runtime_config("tiveor", 10)
    ...
    await create_request(update, context, "tiveor", cost=required_credits)