...
# =============== Comando principal ===============
async def papeletas_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /papeletas.",
    ...
    command_cfg = get_command_runtime_config("papeletas", 8)
    ...
    await create_request(update, context, "papeletas", cost=required_credits)