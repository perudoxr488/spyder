...
# =============== Comando principal ===============
async def rqv_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /rqv.",
    ...
    command_cfg = get_command_runtime_config("rqv", 10)
    ...
    await create_request(update, context, "rqv", cost=required_credits)