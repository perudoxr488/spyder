...
# =============== Comando principal ===============
async def tiveqr_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /tiveqr.",
    ...
    command_cfg = get_command_runtime_config("tiveqr", 15)
    required_credits = int(command_cfg.get("cost", 15))
    ...
    await create_request(update, context, "tiveqr", cost=required_credits)