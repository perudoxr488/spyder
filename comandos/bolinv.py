...
# =============== Comando principal ===============
async def bolinv_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /bolinv.",
    ...
    command_cfg = get_command_runtime_config("bolinv", 8)
    ...
    await create_request(update, context, "bolinv", cost=required_credits)