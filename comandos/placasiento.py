...
# =============== Comando principal ===============
async def placasiento_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /placasiento.",
    ...
    command_cfg = get_command_runtime_config("placasiento", 10)
    ...
    await create_request(update, context, "placasiento", cost=required_credits)