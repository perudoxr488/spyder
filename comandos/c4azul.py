...
# =============== Comando principal ===============
async def c4azul_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text("Por favor, proporciona el número de DNI después de /c4azul.", reply_to_message_id=update.message.message_id)
        return
    dni = context.args[0]
    ...
    command_cfg = get_command_runtime_config("c4azul", 5)
    ...
    await create_request(update, context, "c4azul", cost=required_credits)