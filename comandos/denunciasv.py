...
# =============== Comando principal ===============
async def denunciasv_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /denunciasv.",
    ...
    command_cfg = get_command_runtime_config("denunciasv", 10)
    ...
    await create_request(update, context, "denunciasv", cost=required_credits)