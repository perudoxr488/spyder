...
# =============== Comando principal ===============
async def soat_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /soat.",
    ...
    command_cfg = get_command_runtime_config("soat", 7)
    ...
    await create_request(update, context, "soat", cost=required_credits)