...
# =============== Comando principal ===============
async def insve_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            "Por favor, proporciona el número de placa después de /insve.",
    ...
    command_cfg = get_command_runtime_config("insve", 6)
    ...
    await create_request(update, context, "insve", cost=required_credits)